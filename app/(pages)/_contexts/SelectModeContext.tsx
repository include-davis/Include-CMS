...
export const useSelectMode = () => {
  ...
  if (!context) {
    throw new Error('useSelectMode must be used within a SelectModeContextProvider');
  }
  return context;
};

const SelectModeContextProvider: React.FC<{ children: ReactNode }> = ({ children }) => {
  ...
  return (
    <SelectModeContext.Provider value={{ selectMode, toggleSelectMode, setSelectMode }}>
      {children}
